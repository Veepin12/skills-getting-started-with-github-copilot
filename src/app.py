...
# Added additional activities: 2 more sports, 2 more artistic, 2 more intellectual
activities.update({
    "Volleyball Team": {
        "description": "Competitive volleyball team focusing on drills and matches",
    ...
    "Music Band": {
        "description": "Practice and perform contemporary and classical pieces",
    ...
    "Literature Society": {
        "description": "Book discussions, poetry readings, and writing workshops",
